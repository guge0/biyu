(function () {
  ...
  function openForm() {
    ...
    dialog.innerHTML = `<form method="dialog" class="new-character-form"><h3>新建人物卡</h3>
      <label>姓名（必填）<input required data-new-field="姓名" autofocus><p class="new-character-status" role="status"></p></label>
      ...
      <div class="actions"><button type="button" class="b3" data-cancel>算了</button><button type="submit" class="b1">创建人物卡</button></div></form>`;
